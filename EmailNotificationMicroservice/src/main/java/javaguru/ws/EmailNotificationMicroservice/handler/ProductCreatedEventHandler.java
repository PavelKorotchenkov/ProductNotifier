package javaguru.ws.EmailNotificationMicroservice.handler;

import javaguru.ws.Core.ProductCreatedEvent;
import javaguru.ws.EmailNotificationMicroservice.exception.NonRetryableException;
import javaguru.ws.EmailNotificationMicroservice.exception.RetryableException;
...
public class ProductCreatedEventHandler {
    ...
    public void handle(@Payload ProductCreatedEvent productCreatedEvent,
        ...
        ProcessedEventEntity processedEventEntity = processedEventRepository.findByMessageId(messageKey);
